...
const Populartours = () => {
  return (
    <div className="flex flex-col justify-center items-center space-y-4 bg-slate-50 pb-2 w-full pt-8">
      ...
      <div className="w-full md:w-2/3 lg:w-1/2 xl:w-1/3 mx-auto hover:bg-red-500 bg-purple-500 transition-colors px-5 py-2 rounded-lg font-semibold text-center">
